...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.silverhand.catalog.domain.Product.class.getName(), jcacheConfiguration);
            createCache(cm, com.silverhand.catalog.domain.Category.class.getName(), jcacheConfiguration);
            createCache(cm, com.silverhand.catalog.domain.Category.class.getName() + ".products", jcacheConfiguration);
