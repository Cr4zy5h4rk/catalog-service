...
import com.silverhand.catalog.repository.ProductRepository;
import com.silverhand.catalog.repository.search.ProductSearchRepository;
import com.silverhand.catalog.web.rest.errors.BadRequestAlertException;
import com.silverhand.catalog.web.rest.errors.ElasticsearchExceptionMapper;
...
/**
 * REST controller for managing {@link com.silverhand.catalog.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                updateIfPresent(existingProduct::setStock, product.getStock());
    ...
    public List<Product> searchProducts(@RequestParam("query") String query) {
        ...
        try {
            return StreamSupport.stream(productSearchRepository.search(query).spliterator(), false).toList();
